...
function searchWeather2(lat, lon) {
    ...
    // pridictionContainer.style.visibility = 'visible';

}

//set container position and show data
...
function setOtherItem(value) {
    ...
    // let pridictionContainerHeight = pridictionContainer.clientHeight;
    let pridictionContainerWidth = pridictionContainer.clientWidth;

    let weatherContainer = document.getElementById('weatherContainer');
    let weatherContainerHeight = weatherContainer.clientHeight;

    // pridictionContainer.style.left = `calc(50% - ${pridictionContainerWidth / 2}px)`;
    ...
    // hourlyContainer.style.left = `calc(50% - ${(hourlyContainerWidth / 2)}px)`;
