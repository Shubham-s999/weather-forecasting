...
// new api from srbalar567 account
// let appId = '40d5c0a3c41bca775518df9ab6c62b5a';
...
function init(resultFromServer) {
    ...
    // const dateObject = new Date(epoch_time * 1000)
...
function setPositionForWeatherInfo() {
    ...
    // weatherContainer.style.top = `calc(60% - ${weatherContainerHeight / 3}px)`;
    weatherContainer.style.visibility = 'visible';
}

let prtoggle = 0;
// user search by CITY name
